            ...
            public void onIabSetupFinished(IabResult result) {
                ...
                if (!mEngineReady) {
                    ...
                    if(AccountSession.isLogin()) {
                        StaticUtil.reportError(context, "Market Report:user_id = " + AccountSession.account_id
...
//    }
    ...
    public void purchase(Activity act, Product product,final MarketPurchaseListener mpListener) {
        try{
            ...
            launchPurchaseFlow(act, sku,
                ...
                public void onIabPurchaseFinished(IabResult result, Purchase purchase) {
                    try{
                        ...
                        if(context != null) {
                            StaticUtil.reportError(context,
                                    "Market Report: purchase()  result.isSuccess() = " + result.isSuccess()
                                    + "    purchase.tostring  = " + purchase.toString());
                        }
                    }catch(Exception e) {
                        if(context != null) {
                            StaticUtil.reportError(context, "Market Report: purchase()  " + e.getMessage());
                        } 
                    }
                }
            }
            ...
            if(context != null) {
                StaticUtil.reportError(context, "Market Report Exception purchase()  " + e.getMessage());
            }
        } 
                ...
                consumeAsync(purchases, new IabHelper.OnConsumeMultiFinishedListener() {
                    ...
                    public void onConsumeMultiFinished(List<Purchase> purchases,
                        ...
                        try{
                            ...
                            if(ctx != null) {
                                StaticUtil.reportError(ctx, "Market Report: consumeAsync()  " + e.getMessage());
                            } 
                        }
