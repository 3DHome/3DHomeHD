...
//                    }
                    ...
                    if(mContext != null) {
                        StaticUtil.reportError(mContext, "Market Report: user_id = " + AccountSession.account_id + "  batchOrder()  IOException:" + e.toString());
                    }
                }
...
//                    }
                    ...
                    if(mContext != null) {
                        StaticUtil.reportError(mContext, "Market Report: user_id = " +AccountSession.account_id  + "  batchOrder()  WutongException:" + e.toString());
                    } 
...
//                    }
                    ...
                    mHandler.sendMessage(mds);
                    if(mContext != null) {
                        StaticUtil.reportError(mContext, "Market Report: user_id = " +AccountSession.account_id  + " batchOrder()  response = " + response);
                    } 
    ...
    public void queryPurchases() {
        ...
        public void onQueryInventoryFinished(IabResult result, Inventory inventory, List<Purchase> allPurchases) {
            ...
            if(mContext != null) {
                StaticUtil.reportError(mContext, "Market Report: user_id = " +AccountSession.account_id  + "  queryPurchases()  result.isFailure()" + result.isFailure());
            } 
                ...
                marketIab.consumeAsync(purchases, new IabHelper.OnConsumeMultiFinishedListener() {
                    ...
                    public void onConsumeMultiFinished(List<Purchase> purchases,
                        ...
                        try{
                            ...
                            if(results != null && results.size() > 0) {
                                ...
                                for(int i = 0; i< results.size(); i++) {
                                    if(results.get(i).isSuccess()) {
                                        ...
                                        if(mContext != null) {
                                            StaticUtil.reportError(mContext, "Market Report: consumeAsync()---   " + purchases.get(i).toString());
                                        } 
                                    }
                                }
                            ...
                            if(mContext != null) {
                                StaticUtil.reportError(mContext, "Market Report: user_id = " +AccountSession.account_id  + "  Exception consumeAsync()  " + e.getMessage());
                            } 
