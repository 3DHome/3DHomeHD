...
//    }
    ...
    protected void activeAccount(WutongParameters params,final String email) {
        if (isLoading) {
        ...
        mApiUtil.accountActiveByGoogle(params,
            ...
            public void onComplete(String response) {
                ...
                try {
                    ...
                    AccountSession.login(mActivity.getApplicationContext(),dataObj.optString("id"),dataObj.optString("ticket"),email);
