...
//        mPager.setPageMargin(20);
        ...
        mDownloadOrDeleteButton.setTypeface(fontFace);
    ...
    private void refreshProductStatus(int status) {
        ...
        mDownloadOrDeleteButton.setEnabled(true);
...
//            }
            ...
            mDownloadOrDeleteButton.setText(R.string.state_applied);
...
//            showLoadMessage(R.string.dlg_msg_no_active_connectivity);
    ...
    private void doPaying() {
        if(mActivity != null && BasicActivity.class.isInstance(mActivity)) {
            ...
            mDownloadOrDeleteButton.setText(R.string.action_prepare_purchase);
...
//                      
                    ...
                    Toast.makeText(mActivity, R.string.download_failed_try_again,
                            Toast.LENGTH_SHORT).show();
                    refreshProductStatus(PRODUCT_STATUS_DOWNLOAD);
...
//                    refreshProductStatus(PRODUCT_STATUS_APPLYED);
    ...
    public void hideBottom() {
        BLog.v("hideBottom()----------bottomLayout.id="+bottomLayout.getId() + "---------bottomLayout.getVisibility()="+bottomLayout.getVisibility()); 
    ...
    public void showBottom() {
        BLog.v("showBottom()----------bottomLayout.id="+bottomLayout.getId() + "---------bottomLayout.getVisibility()="+bottomLayout.getVisibility()); 
        if(bottomLayout.getVisibility() != View.VISIBLE) {
