...
public class ProductDescriptionFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        TextView lable_update_time = ((TextView)view.findViewById(R.id.lable_update_time));
        TextView lable_download_count = ((TextView)view.findViewById(R.id.lable_download_count));
