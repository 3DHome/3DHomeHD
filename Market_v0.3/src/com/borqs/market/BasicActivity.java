...
public class BasicActivity extends StaticFragmentActivity implements AccountListener{
    ...
    public boolean onPrepareOptionsMenu(Menu menu) {
        if(WallPaperLocalProductListActivity.class.isInstance(this)) {
            ...
            menu.findItem(R.id.menu_refresh).setVisible(true);
        }else if(WallpaperHomeActivity.class.isInstance(this)) {
            menu.findItem(R.id.menu_refresh).setVisible(true);
