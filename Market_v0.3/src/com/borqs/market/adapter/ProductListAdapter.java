...
//    private LayoutInflater inflater;
    ...
    public ProductListAdapter(Activity activity, ArrayList<Product> datas, boolean online, boolean isPortrait) {
        mActivity = activity;
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        if(online) {
            ...
            if(convertView == null) {
                holder = new ProductItemView(mActivity, mColumn, itemMinWidth);
            }else {
            ...
            if(convertView == null) {
                holder = new ProductLocalItemView(mActivity, mColumn, itemMinWidth);
            }else {
    ...
    public void alertData(ArrayList<Product> datas) {
        calculateColumns();
    	mDatas.clear();
    	mDatas.addAll(datas);
