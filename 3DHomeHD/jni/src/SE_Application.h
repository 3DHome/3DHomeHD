...
//    }
...
#ifdef ANDROID
    void setJavaCallback(void (*javaCallback)(int, const char*))
    {
        mJavaCallback = javaCallback;
    }
    void sendMessageToJava(int msgType, const char* msgName)
    {
    ...
    void setEnableLighting(bool en)
    {
        mEnableLighting = en;
    }
...
#ifdef ANDROID
    void (*mJavaCallback)(int, const char*);
