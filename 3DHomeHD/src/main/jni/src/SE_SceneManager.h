...
public:
    ...
    bool _gatherLight(SE_Light* light);
    void sceneApplyLight();
    ...
    SE_Light::LightPara* updateSceneLight(const char* lightName);    
    void refreshSceneLightStatus();//when occur geometry change scene,should invoke this function
