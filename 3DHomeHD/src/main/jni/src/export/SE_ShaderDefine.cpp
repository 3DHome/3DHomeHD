...
"{\r\n"                                                                                          
    ...
    "vec2 moments = texture2D(u_shadow_texture,ShadowCoordPostW.xy).rg;\r\n"                         
    "\r\n"                                                                                           
...
"{\r\n"                                                                
"float comp = (projCoord.z / projCoord.w) - 0.001;\r\n"                
"float depth =  texture2DProj(u_shadow_texture, projCoord + vec4(x/1024.0,y/1024.0,0.01,0.0)).r;\r\n"          
"float val = 1.0;\r\n"
"val = comp <= depth ? 1.0 : 0.6;\r\n"                                                           
"return val;\r\n"
"}\r\n"
"float generateShadow()\r\n"
"{\r\n"
"float comp = (projCoord.z / projCoord.w) - 0.001;\r\n"
"float depth =  texture2DProj(u_shadow_texture, projCoord).r;\r\n"
"float val = 1.0;\r\n"
"val = comp <= depth ? 1.0 : 0.6;\r\n"                                                           
"if( usePCF == 1)\r\n"
"{\r\n"
...
"void main()\r\n"                                                      
"{\r\n"
//"float result = generateShadow();\r\n"                                                         
"ShadowCoordPostW = projCoord / projCoord.w;\r\n"                                                
"float result = chebyshevUpperBound(ShadowCoordPostW .z);\r\n"                                   
"if(u_shading_mode == 0)\r\n"                                          
"{\r\n"                                                                
    "gl_FragColor = vec4(u_color, 1.0) * result;\r\n"                                                
    "if(useUserAlpha > 0)\r\n"                                             
    "{\r\n"                                                                
    "gl_FragColor.a = gl_FragColor.a * result;\r\n"                  
    "}\r\n"                                                                
...
"{\r\n"                                                                
    ...
    "vec4 basecolor = texture2DProj(u_shadow_texture, projCoord);//basecolor * result;\r\n"            
    //"gl_FragColor = mix(basecolor,vec4(result),0.5);\r\n"                                          
...
"void main()\r\n"                                                                         
"{\r\n"                                                                                   
"lowp vec4 texcolor = (u_shading_mode * texture2D(u_texture, v_tex_coord) + (1.0 - u_shading_mode) * vec4(u_color, 1.0)) * texture2DProj(u_mirror_texture, projCoord);\r\n"
"lowp vec3 resultColor = texcolor.rgb * (u_frag_para * u_lightness);\r\n"
...
"lowp vec3 resultColor = lightcolor.rgb * (u_frag_para * u_lightness);\r\n"
