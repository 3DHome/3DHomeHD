...
public:
    ...
    void addRenderUnit(SE_RenderUnit* ru,const char* mirrorName);
...
private:
    ...
    typedef std::map<std::string,SE_Spatial*> SpatialMap;
    std::map<std::string,SE_Spatial*> mShadowGeneratorCount;
    int mTransformedShadowCreatorNum;
    int mTransformedMirrorCreatorNum;

    bool mIteratorChange;
