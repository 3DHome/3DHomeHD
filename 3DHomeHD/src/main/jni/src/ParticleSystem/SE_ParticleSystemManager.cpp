    ...
    for (t = mParticleSystems.begin(); t != mParticleSystems.end(); ++t)
    {
        ...
        if(ps->isAttachedSpatial())
        {
            ...
            ps->setCurrentPosition(sepos.x,sepos.y,sepos.z);
                    ...
                    this->setAttribute(ps->getName(),FOLLOWPOSITION,affectorname,sepos.x,sepos.y,sepos.z,0);
this->setAttribute(ps->getName(),POSITION,emitername,sepos.x,sepos.y,sepos.z,0);
