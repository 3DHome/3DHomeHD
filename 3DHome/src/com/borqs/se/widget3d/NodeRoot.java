...
public class NodeRoot extends VesselObject implements ScaleGestureDetector.OnScaleGestureListener {
    ...
    public NodeRoot(HomeScene scene, String name, int index) {
        ...
        mCheckSceneStatus = HomeScene.STATUS_APP_MENU + HomeScene.STATUS_DISALLOW_TOUCH + HomeScene.STATUS_HELPER_MENU
                + HomeScene.STATUS_MOVE_OBJECT + HomeScene.STATUS_OBJ_MENU + HomeScene.STATUS_ON_DESK_SIGHT
                + HomeScene.STATUS_ON_SKY_SIGHT + HomeScene.STATUS_ON_WIDGET_SIGHT;
