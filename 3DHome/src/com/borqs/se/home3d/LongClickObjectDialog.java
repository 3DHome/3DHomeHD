...
public class LongClickObjectDialog extends Dialog {
    ...
    public void prepareContent(final NormalObject selectedObject, Bundle bundle) {
        ...
        if (!"Desk".equals(selectedObject.getObjectInfo().mType)) {
            ...
            deleteView.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    new SECommand(mHomeScene) {
                        @Override
                        public void run() {
                            selectedObject.getParent().removeChild(selectedObject, true);
                        }
                    }.execute();
                }
            });
        ...
        if (selectedObject.canChangeBind()) {
            ...
            changeBindView.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    dismiss();
                    mHomeScene.handleMessage(HomeScene.MSG_TYPE_SHOW_BIND_APP_DIALOG, selectedObject);
                }
            });
            ...
            uninstallView.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    if (selectedObject.getObjectInfo().mModelInfo != null
                        ...
                        mHomeScene.handleMessage(HomeScene.MSG_TYPE_SHOW_DELETE_OBJECTS, selectedObject.mName);
                    } else {
        ...
        if (selectedObject.canBeReplaced()) {
            TextView settingView = (TextView) context.getLayoutInflater().inflate(R.layout.object_menu_item, null);
            Drawable iconSetting = context.getResources().getDrawable(R.drawable.long_click_object_changeicon);
            setButtonProperties(settingView, iconSetting, R.string.long_click_object_menu_replace);
            settingView.setOnClickListener(new View.OnClickListener() {

                @Override
                public void onClick(View v) {
                    SESceneManager.getInstance().handleMessage(HomeScene.MSG_TYPE_SHOW_OBJECT_VIEW, OBJECTSHOWTYPE.DESK);
                    dismiss();
        ...
        int cellCountX = mHomeScene.getHomeSceneInfo().mCellCountX;
