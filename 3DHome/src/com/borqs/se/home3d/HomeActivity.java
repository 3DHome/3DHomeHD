...
public class HomeActivity extends StaticActivity implements View.OnCreateContextMenuListener {
    ...
    public static final int MSG_SHOW_DIALOG_UPGRADE = 1001;
...
//        super.setRequestedOrientation(ActivityInfo.SCREEN_ORIENTATION_PORTRAIT);
        ...
        mHomeManager.createSceneManager(this, mHandler, mRenderView);
...
//        SESceneManager.getInstance().setHandler(mHandler);
    ...
    public boolean onMenuOpened(int featureId, Menu menu) {
        ...
        return mHomeManager.onMenuOpened(featureId, menu);
//        return SESceneManager.getInstance().onMenuOpened(featureId, menu);
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        return mHomeManager.onCreateOptionsMenu(menu);
    }

    @Override
    public boolean onPrepareOptionsMenu(Menu menu) {
        super.onPrepareOptionsMenu(menu);
        return mHomeManager.onPrepareOptionsMenu(menu);
    }

    @Override
    public boolean onOptionsItemSelected(MenuItem item) {
        super.onOptionsItemSelected(item);
        return mHomeManager.onOptionsItemSelected(item);
    }
    ...
    protected Dialog onCreateDialog(int id, Bundle bundle) {
        ...
        return mHomeManager.onCreateDialog(id, bundle);
    }
    ...
    protected void onPrepareDialog(int id, Dialog dialog, Bundle bundle) {
        ...
        case ALERT_DIALOG_UPDATE_SW:
            ...
            break;
        default:
            mHomeManager.onPrepareDialog(id, dialog, bundle);
        }
    }
    ...
    protected void onResume() {
        ...
        mHomeManager.resumeSceneManager(this, mHandler, mRenderView);
//        SESceneManager.getInstance().setHandler(mHandler);
//        SESceneManager.getInstance().setGLSurfaceView(mRenderView);
//        SESceneManager.getInstance().setGLActivity(this);
...
//        SESceneManager.getInstance().onActivityPause();
        mHomeManager.pauseSceneManager(mHasLeave3DHome);
    ...
    public void onDestroy() {
        super.onDestroy();
        isLiving = false;
        mHomeManager.onActivityDestroy();
    }
    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        mHomeManager.onActivityResult(requestCode, resultCode, data);
    }
    ...
    protected void onNewIntent(Intent intent) {
        if (Intent.ACTION_MAIN.equals(intent.getAction())) {
            ...
            if (alreadyOnHome) {
                mHomeManager.onNewIntent(intent);
                try {
                    mAppSearchPane = mHomeManager.getAppSearchPane();
                    if (mAppSearchPane != null && mAppSearchPane.getVisibility() == View.VISIBLE) {
                        mAppSearchPane.setVisibility(View.INVISIBLE);
