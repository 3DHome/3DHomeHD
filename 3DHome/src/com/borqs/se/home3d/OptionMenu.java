    ...
    private OnClickListener mClickListener = new View.OnClickListener() {
        ...
        public void onClick(View v) {
            ...
            case R.id.menu00:
                ...
                // dialog出来的时候我们不知道是要更换的是哪面墙的贴图，或者是否是地板贴图，这个时候通知房间要更换当前墙的贴图
                homeScene.mayChangeWallPaper();
                homeScene.handleMessage(HomeScene.MSG_TYPE_SHOW_WALL_LONG_CLICK_DIALOG, null);
                break;
            case R.id.menu01:
