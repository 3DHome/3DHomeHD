...
public class AddObjectDialog extends Dialog implements OnItemCheckListener {
    ...
    public AddObjectDialog(Context context, LayoutInflater inflater, ArrayList<AppItemInfo> itemInfos, int tag, int max, Bundle bundle) {
    ...
    private void init(ArrayList<AddObjectItemInfo> itemInfos) {
        int or = HomeManager.getInstance().getRequestedOrientation();
        ...
        mPagerAdapter = new IIPagerAdapter(mContext, mInflater, itemInfos, this, mNum, nper);
    ...
    private class IIPagerAdapter extends PagerAdapter {
        ...
        public IIPagerAdapter(Context context, LayoutInflater inflater, ArrayList<AddObjectItemInfo> itemInfos, 
